      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm sticky top-24">
            ...
            <button className="w-full bg-amber-600 hover:bg-amber-700 active:scale-95 text-white font-black py-4 rounded-xl transition-all text-base shadow-lg shadow-amber-200">
              پرداخت
            </button>
